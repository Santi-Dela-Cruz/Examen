...
public abstract class DKStyles {
    ...
    // Colores Botones
    public static final Color DKCOLOR_YELLOW = new Color(214, 204, 0);
    public static final Color DKCOLOR_RED = new Color(174, 5, 5);
    public static final Color DKCOLOR_GREEN = new Color(86, 156, 9);
